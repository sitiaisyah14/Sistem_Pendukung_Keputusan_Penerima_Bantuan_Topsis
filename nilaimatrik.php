...
<font size="2px">
	...
	<div class="box-header">
		<br> <h3 class="box-title">Tambah Nilai Matriks</h3>
	</div>

	<form method="POST" action="">
		<div class="form-group">
			<label style="font-size: 20px;" class="control-label col-lg-2">Id Alternatif</label>
			<div class="col-lg-4">
				<select style="font-size: 12px;" name="id_alt" class="form-control">
					<?php
					...
					?>
						...
						<option style="font-size: 15px;" value="<?php echo $d['id_alternatif'] ?>"><?php echo $d['id_alternatif'] . " | " . $d['nm_alternatif'] ?></option>
					<?php
					}
					?>
				</select>
			...
			?>
				...
				<tr>
					<td colspan=5 align="center">
						<br><input style="font-size: 15px;" type="submit" name="simpan" value="Simpan" class="btn btn-primary">
					</td>
				</tr>
				</table>
		</div>
